    ...
    <main className="w-full pt-20">
      <section className="text-center">
        <div className="pb-14">
          ...
          <p className="text-lg font-bold leading-7 text-black px-10 pt-7">
            ما یک تیم کوچک از آدم‌هایی هستیم که به ورزش علاقه داریم و دوست داریم
            تمرین کردن رو ساده‌تر کنیم.
          </p>
        </div>

        <div className="relative px-5 flex justify-end -my-14">
          <Image src={Goal} alt="Gymivo goal" width={119} height={117} />
        </div>
        ...
        <section className="bg-primary-100 p-5">
          ...
          <p className="text-sm leading-6 text-black text-right">
            تجربه ما نشان داد تمرین آنلاین با ابزارهای پراکنده، هم برای مربی
            زمان‌بر است و هم برای ورزشکار گیج‌کننده. ما تصمیم گرفتیم یک راهکار
            اختصاصی برای تمرین واقعی و پیگیری درست بسازیم.
          </p>
        </section>
      </section>
      ...
      <section className="px-4 py-10 bg-white">
        ...
        <div className="flex justify-end mb-8">
          <Image src={Mountain} alt="mountain" width={280} height={220} />
        </div>

        <div className="flex flex-col gap-4">
          <div className="inline-flex items-center gap-1 bg-[#C9F3DD] p-3 rounded-xl self-start">
            <SportsGymnasticsIcon
              style={{ fontSize: 20 }}
              className="text-black"
            />
            <p className="text-base text-neutral-darker font-bold">
              وقتشه کم کم ورزشو بیاریم تو خونه!
            </p>
          </div>

          <div className="inline-flex items-center gap-1 bg-primary-100 p-3 rounded-xl self-end">
            <InsertEmoticonIcon
              style={{ fontSize: 20 }}
              className="text-black"
            />
          ...
          <div className="inline-flex items-center gap-1 bg-primary-100 p-3 rounded-xl self-end">
            <EmojiPeopleIcon style={{ fontSize: 20 }} className="text-black" />
            <p className="text-base text-neutral-darker font-bold">
      ...
      <section className="pt-10">
        ...
        <div className="flex px-5 justify-between gap-4">
          <div className="flex flex-col justify-around gap-6 flex-1">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-neutral-500">توسعه‌دهنده بک‌اند</p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between gap-6 flex-1">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-neutral-500">توسعه‌دهنده فرانت‌اند</p>
            </div>
        ...
        <div className="pb-20 bg-[#F3FCF7] p-5 text-center">
