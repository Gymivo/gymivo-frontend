...
export default function Header() {
  ...
  return (
    <>
      <header className="w-[330px] h-14 z-50 fixed flex items-center p-3 border border-white/25 shadow-xs shadow-white rounded-3xl bg-black/60 backdrop-blur-[20px] top-[10px] left-1/2 -translate-x-1/2">
